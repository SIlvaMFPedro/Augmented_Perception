...
// Publishers
Publisher pub_targets;
Publisher markers_publisher;
Publisher pub_targetsSug;
Publisher markers_publisherSug;

Publisher pub_scans;
Publisher pub_scans_filtered;
Publisher pub_scans_suggest;

Publisher camera_lines_pub;
...
pcl::PointCloud<pcl::PointXYZ> pointDatapclSug, pointDatapcl, pointDatapclFiltered, pointData0pcl, pointData1pcl, pointData2pcl, pointData3pcl, pointDataEpcl, pointDataDpcl;
sensor_msgs::PointCloud2 pointDataSug, pointData, pointData0, pointData1, pointData2, pointData3, pointDataE, pointDataD;
