...
/**
 * This function will convert the point cloud data into a laser scan type structure
 * @param cloud
 * @param data
 */
...
/**
 * THis function will find the clustering threshold between two points and save the result in a configuration
 * @param r1
 * @param t1
 * @param r2
 * @param t2
...
/**
 * This function will realize the clustering of the data of the point clouds
 * @param data
 * @param clustersPtr
 * @param config
 * @param flags
...
/**
 * This function will calculate the cluster position for each data
 * @param clusters
 * @param data
 */
...
/**
 * This function will find the distance between two points in a line
 * @param alpha
 * @param ro
 * @param x
 * @param y
...
/**
 * This function will cluster two vector objects
 * @param objectsPtr
 * @param clusters
 * @param data
 * @param config
...
/**
 * This function mallocs a line to work with, each time it mallocs a line it increments the number of lines of the object data
 * @param object
 * @param data
 * @param start
 * @param end
...
/**
 * Line Fitting Recursive function
 * @param object
 * @param cluster
 * @param data
 * @param config
...
/**
 * Check Association Criteria function
 * @param list
 * @param object
 * @return
 */
...
/**
 * Single Object Association Function
 * @param list
 * @param object
 */
...
/**
 * Remove a certain object from the list of objects
 * @param list
 * @param id
 */
...
/**
 * Add an certain object to list of objects
 * @param list
 * @param object
 * @param config
 */
...
/**
 * Allocate Motion Model with a certain config
 * @param list
 * @param config
 */
...
/**
 * Allocate Errors in model with config
 * @param error
 * @param config
 */
...
/**
 * Set Object Morphology Function
 * @param list
 * @param object
 */
...
void CreateMarkersSug(vector<visualization_msgs::Marker> &marker_vector, mtt::TargetListPC &target_msg, vector<t_listPtr> &list) {
    static map<pair<string, int>, pair<visualization_msgs::Marker, int> > marker_map;
